...
CHARACTERS = {
    ...
    "cactus": {
        "sleeping": [[r"  \|/   ", r" |(-.-)| z", r"  |___|  "],
                     [r"  \|/   ", r" |(-.-)|zz", r"  |___|  "]],
        "working":  [[r"  \|/   ", r" |(o.o)| ", r"  |___|  "],
                     [r"  \|/   ", r" |(o.O)| ", r"  |___|  "]],
        "happy":    [[r"  \|/ * ", r" |(^.^)| ", r"  |___|  "],
                     [r"  *\|/  ", r" |(>.<)| ", r"  |___|  "]],
        "perked":   [[r"  \|/   ", r" |(o.o)|?", r"  |___|  "],
                     [r"  \|/   ", r" |(O.o)|?", r"  |___|  "]],
        "alert":    [[r"  \|/   ", r" |(O.O)|!", r"  |___|  "],
                     [r"  \|/   ", r" |(O.O)|!!", r"  |___|  "]],
        "alarmed":  [[r"  \|/ ! ", r" |(ಠ.ಠ)|!!", r"  |^^^|  "],
...
BABY = {
    ...
    "cactus":  {"sleeping": [[r"  \|/  ", r"  (-.-)z", r"  |_|  "],
                             [r"  \|/  ", r"  (-.-)zz", r"  |_|  "]],
                "working":  [[r"  \|/  ", r"  (o.o)", r"  |_|  "],
                             [r"  \|/  ", r"  (o.O)", r"  |_|  "]]},
    "crab":    {"sleeping": [[r" (\/)  ", r" (-.-)z", r" /'\   "],
                             [r" (\/)  ", r" (-.-)zz", r" /'\   "]],
                "working":  [[r" (\/)  ", r" (o.o)", r" /'\   "],
                             [r" (/\)  ", r" (o.O)", r" \'/   "]]},
    "octopus": {"sleeping": [[r"  ,^.  ", r" (~-.-~)z", r"  |~|  "],
                             [r"  ,^.  ", r" (~-.-~)zz", r"  |~|  "]],
                "working":  [[r"  ,^.  ", r" (~o.o~)", r"  |~|  "],
                             [r"  ,^.  ", r" (~o.O~)", r"  ~|~  "]]},
}
...
PHRASES = {
    ...
    "cactus": {
        "sleeping": ("dormant. as intended.", "conserving. always conserving.",
                     "i do this for months at a time", "no water, no worries, no problem"),
        "working":  ("i require nothing. carry on.", "still here. still fine.",
                     "low maintenance, high presence", "you hydrate. i'll wait."),
        "happy":    ("that was adequate. thank you.", "a rare bloom",
                     "i have flowered. briefly.", "acceptable levels of affection"),
        "perked":   ("something concluded, i think", "oh. movement.",
                     "an event. how novel.", "did something finish out there"),
        "alert":    ("it has been a while now", "i have waited longer, but still",
                     "this is going stale", "patience is my thing, but come on"),
        "alarmed":  ("THIS NEEDS YOU NOW", "SOMETHING IS BADLY WRONG",
                     "ATTEND TO THIS IMMEDIATELY", "I DO NOT PANIC. I AM PANICKING."),
        "offline":  ("i see nothing out there", "the source has gone dry",
                     "no signal. i endure.", "disconnected. still standing."),
    },
    "crab": {
        "sleeping": ("burrowed in. do not dig.", "asleep. claws still up though.",
                     "resting sideways, as one does", "low tide. low effort."),
        "working":  ("approaching this from the side", "i'll pinch anything that breaks",
                     "scuttling alongside you", "sideways is a valid strategy"),
        "happy":    ("*happy claw clack*", "you may pet the shell. once.",
                     "i permit this affection", "claws down. that's rare."),
        "perked":   ("oh? something moved.", "did that just finish",
                     "sensing a change in the current", "hm. developments."),
        "alert":    ("it's been sitting there a while", "someone should deal with that",
                     "i'm getting snappy about this", "tick tock, tide's going out"),
        "alarmed":  ("PINCH ALERT. HANDLE THIS.", "SOMETHING IS VERY WRONG HERE",
                     "CLAWS UP. ACT NOW.", "THIS NEEDS YOU. IMMEDIATELY."),
        "offline":  ("lost the current entirely", "can't sense anything out there",
                     "washed up. no signal.", "the tide took the data with it"),
    },
    "octopus": {
        "sleeping": ("all eight arms, finally still", "eight limbs, zero tasks. bliss.",
                     "powered down. all of me.", "not juggling anything. weird."),
        "working":  ("doing six things. all of them badly.", "eight arms and still not enough",
                     "i've got this. and that. and those.", "multitasking is a lifestyle"),
        "happy":    ("all arms wiggling at once", "*delighted tentacle flail*",
                     "every limb approves of this", "eight thumbs up, metaphorically"),
        "perked":   ("one of my arms noticed something", "oh! a thing concluded!",
                     "wait, which arm was that", "something finished, i think"),
        "alert":    ("this one's been dangling a while", "an arm is still holding this, fyi",
                     "i can only hold so much", "running out of free tentacles"),
        "alarmed":  ("ALL ARMS SIGNALLING. LOOK.", "THIS ONE NEEDS YOU NOW",
                     "EIGHT ARMS POINTING AT THIS", "DROP EVERYTHING. I HAVE."),
        "offline":  ("all arms grasping at nothing", "can't feel anything out there",
                     "the water's gone quiet", "no signal on any limb"),
    },
}
...
COMPACT = {
    ...
    "cactus":  {"sleeping": "|-.-|", "working": "|o.o|", "happy": "|^.^|",
                "perked": "|o.O|", "alert": "|O.O|", "alarmed": "|ಠ.ಠ|", "offline": "|x.x|"},
    "crab":    {"sleeping": "%-.-%", "working": "%o.o%", "happy": "%^.^%",
                "perked": "%o.O%", "alert": "%O.O%", "alarmed": "%ಠ.ಠ%", "offline": "%x.x%"},
    "octopus": {"sleeping": "8-.-8", "working": "8o.o8", "happy": "8^.^8",
                "perked": "8o.O8", "alert": "8O.O8", "alarmed": "8ಠ.ಠ8", "offline": "8x.x8"},
}
